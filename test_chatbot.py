...
# tokenizer_model_path = "/mnt/Fast/models/bluemoon-4k-13b-4bit-128g/tokenizer.model"
# model_config_path = "/mnt/Fast/models/bluemoon-4k-13b-4bit-128g/config.json"
# model_path = "/mnt/Fast/models/bluemoon-4k-13b-4bit-128g/bluemoonrp-13b-4k-epoch6-4bit-128g.safetensors"
# model_groupsize = 128
# break_on_newline = True
# model_seq_len = 4096
...
generator.settings.token_repetition_penalty_sustain = 128
...
# Bluemoon (how is this model meant to work?)

# username = "ASSOCIATE"
# bot_name = "LEAD"
# past = "A transcript of a roleplay between two players, LEAD and ASSOCIATE. LEAD sets up a scenario and the characters, from " \
#     "which ASSOCIATE then assumes a character role and continues the story for that role in response to description given " \
#     "by LEAD. The story and characters are developed by exchange of detailed event descriptions and character dialogs, " \
#     "successively given by both LEAD and ASSOCIATE.\n" \
#     "LEAD: Your phone is ringing.\n"
